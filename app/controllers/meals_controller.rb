class MealsController < ApplicationController
  ...
  def create
    ...
    @meal.chef = current_user

    respond_to do |format|
      if @meal.save
        format.html { redirect_to profile_path(current_user), notice: 'Meal was successfully created.' }
  ...
  private
    ...
    def meal_params
      params.require(:meal).permit(:name, :description, :photo, :category, :price, :address, :photo_cache)
